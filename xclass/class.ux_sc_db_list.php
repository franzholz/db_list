 ...
 *
 * $Id: db_list.php 5526 2009-06-02 13:52:04Z benni $
 ...
 * @subpackage core
 */
class ux_SC_db_list extends tx_dblist_script {

}


if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/db_list/xclass/class.ux_sc_db_list.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/db_list/xclass/class.ux_sc_db_list.php']);
}
